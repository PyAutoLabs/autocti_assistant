...
def test_extract_canonicac_keys_from_source_markdown():
    citations = extract_canonicac_keys(
        """
## Alpha 2024 — result
...
def test_detect_missing_canonicac_key(tmp_path):
