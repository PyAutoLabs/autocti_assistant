...
|---|---|---|---|
| [`core/`](./core/) | *What is X / which X / why X* in the PyAuto\* stack? | Curated from source repos listed in [`../sources.yaml`](../sources.yaml) | `ac_update_wiki` skill, against pinned source commits |
...
- **`core/`** is treated as read-only outside of `ac_update_wiki` runs. Don't edit pages
